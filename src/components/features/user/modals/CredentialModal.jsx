...
const CredentialModal = ({
  ...
  console.log("CREDENTIAL MODAL DATA:", credentialData);
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
          ...
          <div className="flex flex-col items-center">
            <div className="w-64 h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-6 border-2 border-dashed border-gray-300">
              {credentialData.faceImage ? (
                <img
                  src={
                    typeof credentialData.faceImage === "string"
                      ? credentialData.faceImage
                      : URL.createObjectURL(credentialData.faceImage)
                  }
                  alt="Face"
          ...
          <div className="flex flex-col items-center">
            <div className="w-full max-w-md mb-6">
              ...
              <input
                ...
                onChange={(e) =>
                  onCredentialChange("userPassword", e.target.value)
                }
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
              />
