          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Clock in</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Device</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Clock out</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Device</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Duration (H)</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Lateness Duration (H)</th>
                    <th className="text-left py-4 px-6 text-gray-700 font-semibold">Departure Duration (H)</th>
                  </tr>
                </thead>
                <tbody>
                  {attendanceData.map((item) => (
                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-6 text-gray-500">{item.group}</td>
                      <td className="py-4 px-6 text-gray-500">{item.phone}</td>
                      <td className="py-4 px-6 text-gray-700">{item.date}</td>
                      <td className="py-4 px-6 text-gray-500">{item.clockIn}</td>
                      <td className="py-4 px-6 text-gray-500">{item.deviceIn}</td>
                      <td className="py-4 px-6 text-gray-500">{item.clockOut}</td>
                      <td className="py-4 px-6 text-gray-500">{item.deviceOut}</td>
                      <td className="py-4 px-6 text-gray-500">{item.duration}</td>
                      <td className="py-4 px-6 text-gray-500">{item.lateness}</td>
                      <td className="py-4 px-6 text-gray-500">{item.departure}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200">
              <div className="text-sm text-gray-600">
                Total <span className="font-semibold">6</span>
              </div>
