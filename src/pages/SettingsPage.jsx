      ...
      <div className="bg-white rounded-lg border border-gray-200">
        {activeTab === 'system' && (
          <div className="p-4 md:p-8">
            ...
            <div className="mb-8">
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-4 md:mb-6">Account information</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  ...
                  <div className="text-gray-800 font-medium text-sm md:text-base">Veridface Company</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  <div className="text-xs md:text-sm text-gray-600 mb-2">Organization Id</div>
                  <div className="text-gray-800 font-medium text-sm md:text-base">9z1c1jydzv1dgpzf</div>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  <div className="text-xs md:text-sm text-gray-600 mb-2">appKey</div>
                  <div className="text-gray-800 font-medium text-sm md:text-base">9z1c1jydzv1dgpzf</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  <div className="text-xs md:text-sm text-gray-600 mb-2">appSecret</div>
                  <div className="text-gray-800 font-medium text-sm md:text-base break-all">l54ckwoq6wwxdifpz9ifie5u0cj0lf7x</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 md:p-4">
                  <div className="text-xs md:text-sm text-gray-600 mb-2">Version number</div>
                  <div className="text-gray-800 font-medium text-sm md:text-base">V1.0.4</div>
                </div>
              </div>
                </div>
                ...
                <div className="mb-8">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-4 md:mb-6">Account settings</h3>
                  
                  <div className="bg-gray-50 rounded-lg p-4 md:p-6">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4">
                      <span className="text-gray-700 font-medium text-sm md:text-base md:min-w-[200px]">Access QR code configuration</span>
                ...
                <div className="mb-8">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 md:p-6">
                    <div className="flex flex-col md:flex-row md:items-start gap-3 md:gap-4">
                      <span className="text-gray-700 font-medium text-sm md:text-base md:min-w-[200px] md:pt-2">Timezone setting</span>
                      <select
                        value={timezone}
                        onChange={(e) => setTimezone(e.target.value)}
                        className="w-full md:flex-1 px-3 md:px-4 py-2 md:py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                      >
                ...
                <div className="mb-8">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-4 md:mb-6">Callback settings</h3>
                  
                  <div className="bg-gray-50 rounded-lg p-4 md:p-6">
                    <div className="flex flex-col md:flex-row md:items-start gap-3 md:gap-4">
                      <span className="text-gray-700 font-medium text-sm md:text-base md:min-w-[200px] md:pt-2">Callback settings</span>
                      <input
                        type="text"
                ...
                <div className="mb-8">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-4 md:mb-6">App Download</h3>
            ...
            {activeTab === 'form' && (
              <div className="p-4 md:p-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800">Visitor invitation form</h3>
                  <button className="text-blue-400 hover:text-blue-500 font-medium text-sm md:text-base px-4 py-2 md:px-0 md:py-0">
                    Save
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">My name</span>
                  ...
                  {/* Phone */}
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Phone</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-blue-400 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
                  ...
                  {/* Interviewee */}
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Interviewee</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Interviewee phone/email</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" />
                      <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-blue-400 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
                  ...
                  {/* Face */}
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Face</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-blue-400 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
                  ...
                  {/* Note */}
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Note</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-blue-400 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
                  ...
                  {/* Time */}
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <span className="text-gray-700 text-sm md:text-base">Time</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-blue-400 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between py-3">
                    <span className="text-gray-700 text-sm md:text-base">Visitor code expiration time</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" />
                      <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-blue-400 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                    </label>
