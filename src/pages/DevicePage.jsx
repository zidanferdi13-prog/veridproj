    ...
    <MainLayout>
      ...
      <div className="mb-6 flex flex-wrap gap-2 md:gap-3">
        <button
          ...
          className="px-3 md:px-4 py-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors font-medium border border-green-200 text-sm md:text-base"
        >
          + Add device
        </button>
        <button
          onClick={handleDelete}
          className="px-3 md:px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors font-medium border border-red-200 text-sm md:text-base"
        >
          🗑️ Delete
        </button>
      </div>
